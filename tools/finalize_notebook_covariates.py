...
def write_summary(
    ...
    lines.append("")
    lines.append("## Files")
    lines.append("- Output filenames are controlled by the command-line arguments passed to this script.")
    lines.append("- If the approximate-georeference pass is applied afterward, use the resulting `*_geoaugmented.csv` files as the current covariate layer.")
