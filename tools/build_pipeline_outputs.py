...
def build_manifest() -> str:
    return "\n".join(
        [
            ...
            "",
            "Upstream source-of-truth files live under `data/screening/`, `data/extraction/`, and `notebook_covariates/`.",
            ...
            "",
            "Downstream source-review and crop files under `digitization/` are generated by the follow-on commands documented in `docs/pipeline/EXTRACTION_PIPELINE.md`.",
            "",
