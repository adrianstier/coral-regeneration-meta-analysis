...
- **Generated QA outputs:** Rebuild `pipeline/` with `python3 tools/build_pipeline_outputs.py`, rebuild extraction-review queues with `python3 tools/build_extraction_review_artifacts.py`, merge figure-candidate audits with `python3 tools/merge_figure_candidate_audits.py`, render audited source pages with `python3 tools/render_audited_source_pages.py`, build the visual reaudit with `python3 tools/build_figure_visual_reaudit.py`, then build crop proposals with `python3 tools/build_figure_crop_manifest.py`; review `pipeline/PIPELINE_QA_REPORT.md`, `digitization/source_review/EXTRACTION_REVIEW_SUMMARY.md`, `digitization/source_review/FIGURE_CANDIDATE_AUDIT_SUMMARY.md`, `digitization/source_review/FIGURE_VISUAL_REAUDIT_SUMMARY.md`, and `digitization/figures/FIGURE_CROP_SUMMARY.md` before using manuscript counts or extracted values.
